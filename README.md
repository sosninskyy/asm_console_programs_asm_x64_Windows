...
+
# Enc-Dec-Ryptor
# A simple program that encrypt and decrypt strings, written in x64 Assembly (NASM) for Windows
# How it works
- You enter string
- Program print encrypted and decrypted 
...
# Change the filename depending on what it is name.
